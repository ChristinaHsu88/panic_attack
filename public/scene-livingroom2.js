...
Crafty.scene('livingroom2', function() {
  ...
  Crafty.e('2D, DOM, Solid, WallBottomLeftVertical, Collision')
  .attr({ x: 390, y: 250, h: 80, w: 5 })

  Crafty.e('2D, DOM, Solid, WallBottomRightVertical, Collision')
  .attr({ x: 440, y: 250, h: 80, w: 5 })
