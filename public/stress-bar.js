Crafty.sprite(65, 300, 'assets/blue.png', { blueStress:[0, 0, ] }) // stress 0-2
Crafty.sprite(65, 300, 'assets/green.png', { greenStress:[0, 0] }) // stress 3-5
Crafty.sprite(65, 300, 'assets/orange.png', { orangeStress:[0, 0] }) // stress 6-8
Crafty.sprite(65, 300, 'assets/red.png', { redStress:[0, 0] }) // stress 9-10
